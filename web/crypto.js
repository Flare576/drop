// Ported from ../shared/crypto.ts for direct browser use — see web/README.md for why this
// is a copy rather than a live cross-directory import. Logic is a line-for-line match of
// shared/crypto.ts; only TypeScript type annotations are stripped. If shared/crypto.ts ever
...
const CHUNK_SIZE = 0x8000; // 32KB chunks — avoids String.fromCharCode stack overflow on large payloads
...
async function deriveKey(credentials) {
